...
class MainWindow(QMainWindow):
    ...
    def informartionDelete(self):
        ...
        val = []
        val.append(self.lineEdit_ID.text())
        print(val)
        masql = db.cursor()
        sql_d1 = "DELETE  FROM information_1 WHERE id=%s"
        sql_d2 = "DELETE  FROM information_2 WHERE id=%s"
        masql.execute(sql_d1,val)
        masql.execute(sql_d2,val)
        db.commit()
